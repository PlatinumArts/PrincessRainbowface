...
arcadet = {
	...
	on_place = function(itemstack, placer, pointed_thing)
		...
		if minetest.get_node({x=pos.x, y=pos.y+1, z=pos.z}).name ~= "air" then
			minetest.chat_send_player(placer:get_player_name(), "No enough space To Place This Tetris Arcade"" )
		return end
		local dir = placer:get_look_dir()
		local node = { name="more_stuff:tetris", param1=0, param2 = minetest.dir_to_facedir(dir)}
		minetest.set_node(pos, node)
		itemstack:take_item()
	end,
}

minetest.register_node("more_stuff:tetris", arcadet)
